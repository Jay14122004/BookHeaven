...
function Cart() {
  ...
  return (
    <div className='bg-zinc-900 px-12 min-h-screen h-auto py-8'>
          ...
          {Cart.map((items,index)=> (
            ...
            >
              ...
              <div className='flex mt-4 w-full md:w-auto items-center justify-between'> 
                ...
                <button
                    className='cursor-pointer bg-red-100 text-red-700 border border-red-700 rounded p-2 ms-12'
        ...
        <div className='mt-4 w-full flex items-center justify-end'>
          <div className='p-4 bg-zinc-800 rounded'>
            ...
            <div className='w-[100%] mt-3'>
              <button className='cursor-pointer bg-zinc-100 px-4 py-2 flex justify-center w-full font-semibold hover:bg-zinc-200'
              onClick={PlaceOrder}
              >
                Place your order
              </button>
